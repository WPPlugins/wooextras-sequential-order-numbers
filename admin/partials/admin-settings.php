...
<div id="admin-custom" class="wrap metabox-holder columns-2 wp_cbf-metaboxes">
    ...
    <fieldset>
        <legend class="screen-reader-text"><span><?php _e('Order Number Start:', $this->plugin_name); ?></span></legend>
        <label for="<?php echo $this->plugin_name; ?>-woo_extra_son_ons">
            <span><?php esc_attr_e('Order Number Start:', $this->plugin_name); ?></span>
        </label>
