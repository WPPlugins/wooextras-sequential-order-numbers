...
function woo_extra_son_links($links, $file) {
	if ($file == plugin_basename(__FILE__)) {
		$links[]  = '<a target="_blank" href="https://woocommerce.ezosc.com/?utm_source=wp-extras-son&utm_medium=link-plugins&utm_campaign=wp-extras-son%20get%20support" title="Get Support" style="padding:1px 5px;color:#fff;background:#feba12;border-radius:1px;">Get&nbsp;Support</a>';
	}
	return $links;
}
